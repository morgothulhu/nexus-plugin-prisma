...
This plugin has been upgraded to support **Prisma 4.0+**. Latest version of prisma supported: [Prisma 5.22.0](https://github.com/prisma/prisma/releases/tag/5.22.0)
